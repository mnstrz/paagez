...
@push('meta')
<title>{{__('paagez.rest')}} - {{config('paagez.app_name')}}</title>
@endpush
                ...
                <div class="card p-3 shadow w-100 shadow border-0">
                    ...
                    <div class="mb-2">
                       <table class="table table-borderless">
                           <tbody>
                               <tr>
                                   <td width="150px">LOGIN ENDPOINT</td>
                                   <td><span class="text-warning">POST</span> <code>/api/login</code></td>
                               </tr>
                               <tr>
                                   <td width="150px">PROFILE ENDPOINT</td>
                                   <td><span class="text-success">GET</span> <code>/api/profile</code></td>
                               </tr>
                           </tbody>
                       </table>
                    </div>
